...
def main():
    ...
    export_result = '{{Page version|{}}}<!--pz-room-define-to-items version {}-->'.format(VERSION['PZ'], VERSION['PROJECT'])
    
    export_result = export_result + '{{Autogenerated|reason=Any changes to this page will be overwritten automatically.|source=[https://github.com/CalvyPZ/pz-room-define-items-to-wiki pz-room-define-items-to-wiki (GitHub)]}}'
